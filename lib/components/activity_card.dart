                ...
                children: [
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        CircleAvatar(maxRadius: 30, backgroundImage: AssetImage(transactionRefer.startUser.imagePath ?? 'images/me.jpg'),)
                      ],
                    ),
                  ),
                  Expanded(
          ...
          Expanded(
            child: Container(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Text('R\$50,00', style: TextStyle(color: Colors.red, fontWeight: FontWeight.w700),),
